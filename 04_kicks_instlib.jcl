...
//SYSIN DD *
 ...
 SET MAXCC = 0
 DEFINE CLUSTER                                       -
      (NAME(K.U.MURACH.CUSTMAS) VOLUMES(PUB001) -
 ...
 DEFINE CLUSTER                                       -
      (NAME(K.U.MURACH.PRODUCT) VOLUMES(PUB001) -
       TRACKS(15 15)  INDEXED                         -
       SHAREOPTIONS(1 3) UNIQUE                       -
 ...
 DEFINE CLUSTER                                       -
      (NAME(K.U.MURACH.INVOICE) VOLUMES(PUB001) -
       TRACKS(15 15)  INDEXED                         -
       SHAREOPTIONS(1 3) UNIQUE                       -
...
//SYSIN DD *
 ...
 SET MAXCC = 0
 DEFINE CLUSTER                                       -
      (NAME(K.U.TACDATA) VOLUMES(PUB001)                     -
       TRACKS(15 15)  NONINDEXED                      -
       SHAREOPTIONS(1 3) UNIQUE                       -
       RECORDSIZE(204 204)                            -
      )                                               -
     DATA ( NAME(K.U.TACDATA.DATA))
/*
//*
...
//SYSIN DD *
 REPRO INFILE(TACDATA) OUTDATASET(K.U.TACDATA)
/*
//